...
export default class Projects extends React.Component {
  ...
  render() {
    const projects_array = this.isMobileCheck()
    ...
    return (
      <div className={projects_container}>
        ...
        <div
          className={this.isMobileCheck() ? projects_box_mobile : projects_box}
        >
          {projects_array.map((project, index) => (
            <div
              className={
                this.isMobileCheck() ? project_box_mobile : project_box
              }
            >
              <div
                className={
                  this.isMobileCheck() ? project_text_mobile : project_text
                }
              >
